	...
	<div>
		...
		<form action="UpdateInsertMissionServlet" method="POST">
			<input type="hidden" name="mission_id"
				value="<c:out value="${mission_id}"></c:out>"> 
			<input
				type="hidden" name="mission_type"
				value="<c:out value="${mission_type}"></c:out>">
			<input
				type="hidden" name="map_id"
				value="<c:out value="${map_id}"></c:out>">
			<input
				type="hidden" name="map_sector11"
				value="<c:out value="${map_sector11}"></c:out>">
			<input
				type="hidden" name="map_sector12"
				value="<c:out value="${map_sector12}"></c:out>">
			<input
				type="hidden" name="map_sector13"
				value="<c:out value="${map_sector13}"></c:out>">
			<input
				type="hidden" name="map_sector21"
				value="<c:out value="${map_sector21}"></c:out>">
			<input
				type="hidden" name="map_sector22"
				value="<c:out value="${map_sector22}"></c:out>">
			<input
				type="hidden" name="map_sector23"
				value="<c:out value="${map_sector23}"></c:out>">
			<input
				type="hidden" name="map_sector31"
				value="<c:out value="${map_sector31}"></c:out>">
			<input
				type="hidden" name="map_sector32"
				value="<c:out value="${map_sector32}"></c:out>">
			<input
					...
					<div class="table-column-report">
						...
						<div class="location-row-report">
							...
							<div class="location-insert-report">
								<p>Map center coordinates (comma separated latitude and longitude):</p>
								...
								<c:if test="${not empty map_id}">
									<div class="grid">
										<div class="grid-row">
											<div class="grid-cell" id="11" <c:if test="${map_sector11}">style="background-color: rgba(113, 238, 100, 0.23)"</c:if>></div>
											<div class="grid-cell" id="12" <c:if test="${map_sector12}">style="background-color: rgba(113, 238, 100, 0.23)"</c:if>></div>
											<div class="grid-cell" id="13" <c:if test="${map_sector13}">style="background-color: rgba(113, 238, 100, 0.23)"</c:if>></div>
										</div>
										<div class="grid-row">
											<div class="grid-cell" id="21" <c:if test="${map_sector21}">style="background-color: rgba(113, 238, 100, 0.23)"</c:if>></div>
											<div class="grid-cell" id="22" <c:if test="${map_sector22}">style="background-color: rgba(113, 238, 100, 0.23)"</c:if>></div>
											<div class="grid-cell" id="23" <c:if test="${map_sector23}">style="background-color: rgba(113, 238, 100, 0.23)"</c:if>></div>
										</div>
										<div class="grid-row">
											<div class="grid-cell" id="31" <c:if test="${map_sector31}">style="background-color: rgba(113, 238, 100, 0.23)"</c:if>></div>
											<div class="grid-cell" id="32" <c:if test="${map_sector32}">style="background-color: rgba(113, 238, 100, 0.23)"</c:if>></div>
											<div class="grid-cell" id="33" <c:if test="${map_sector33}">style="background-color: rgba(113, 238, 100, 0.23)"</c:if>></div>
										</div>
									</div>
								</c:if>
							</div>
